...
export function CalculatorCard({ calculator }: { calculator: CalculatorInfo }) {
  return (
    <Link href={calculator.path} className="group block rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-soft sm:p-6">
