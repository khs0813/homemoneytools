    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="rounded-3xl border border-slate-200 bg-white p-4 shadow-soft sm:p-6">
        <div className="grid gap-5 md:grid-cols-2">
          ...
          <Controller name="conversionRate" control={control} render={({ field }) => <PercentInput label="전월세 전환율" required value={field.value} onChange={field.onChange} min={0.01} max={30} />} />
