    ...
    <>
      ...
      <LegalPage
        ...
        sections={[
          {
            title: "1. 목적",
            body: "본 약관은 이용자가 생활 금융 계산기와 가이드 콘텐츠를 이용할 때 필요한 기본 사항을 정합니다."
          },
          {
            title: "2. 서비스의 성격",
            items: [
              "본 서비스는 실수령액, 대출이자, 퇴직금, 배당금, 환율, 세금, 공과금, 생활비, 부동산 비용 등에 관한 참고용 계산 결과와 설명형 콘텐츠를 제공합니다.",
          ...
          },
          {
            ...
            items: [
              ...
              "중요한 계약, 대출, 세금 신고, 투자, 급여 협의 전에는 반드시 금융기관, 세무사, 노무사, 관계 기관 등과 최신 기준을 확인해야 합니다.",
