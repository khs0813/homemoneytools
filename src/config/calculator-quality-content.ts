...
export const calculatorQualityContentBySlug: Record<string, CalculatorQualityContent> = {
  ...
  "home-purchase-total-cost": {
    checks: ["취득세 및 부가 세목", "중개수수료", "대출 실행 후 필요한 자기자본", "월 원리금", "예상 DSR", "계약금·잔금 시점별 필요 현금", "거래 후 남는 현금"],
    basisNote: "취득세, 중개수수료, 대출 상환, DSR은 기존 계산 서비스를 조합하고, 이사비·법무비·기타 비용은 사용자가 직접 입력한 금액만 반영합니다.",
    shortDisclaimer: "내 집 마련 총비용은 자금계획 참고값입니다. 실제 대출 승인, 세금 신고, 법무비 견적, 계약금 구조는 관계 기관과 계약서 기준을 우선해야 합니다."
  },
