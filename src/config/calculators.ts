...
export const calculators: CalculatorInfo[] = [
  ...
  },
  {
    ...
    formula: "만기일시상환은 대출금액 × 연이율 ÷ 12로 월 이자를 계산합니다. 연 보증료율은 대출기간 전체에 곱하고, 중도상환수수료는 잔존기간 감면 전 최대 추정치로 표시합니다.",
    ...
    faqs: [
      ...
      { question: "보증료도 계산에 포함되나요?", answer: "선택 입력한 연 보증료율이 있으면 대출기간 전체의 예상 보증료를 별도로 표시합니다." },
  ...
  },
  {
    ...
    caution: "예금금리, 전세대출금리, 월세 상승률, 보증금 변동에 따라 실제 유불리가 달라질 수 있습니다. 보증금 기회비용은 단리 참고값입니다.",
    faqs: [
  ...
  },
  {
    ...
    formula: "DSR = 모든 대출의 연간 원리금 상환액 ÷ 연소득 × 100입니다. 일시상환 신용대출 기본값은 5년 산정만기 원금과 연 이자를 더해 반영합니다.",
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "지방교육세와 농어촌특별세도 포함되나요?", answer: "지방교육세는 계산에 포함하고, 전용 85㎡ 초과 선택 시 농어촌특별세를 참고값으로 함께 표시합니다." },
  ...
  },
  {
    ...
    formula: "중개보수는 거래금액 × 실제 적용요율로 계산하며, 입력 협의요율이 법정 상한을 넘으면 상한요율로 제한합니다.",
    example: "매매가 5억 원이고 상한요율이 0.4%이면 중개보수 상한은 200만 원, 부가세 10% 포함 시 220만 원입니다.",
    caution: "중개보수는 상한요율 내에서 협의할 수 있으며 지역, 거래 유형, 주택 여부, 중개업소 과세유형에 따라 달라질 수 있습니다.",
    faqs: [
  ...
  },
  {
    ...
    example: "전세금 5억 원, 보증금 1억 원, 전환율 4.75%이면 월세는 약 158만 3,333원입니다.",
    caution: "전세→월세에는 법정 상한 참고값이 적용될 수 있으며, 월세→전세 결과는 동일 전환율을 이용한 비교용 역산입니다.",
    faqs: [
  ...
  },
  {
    ...
    shortTitle: "청약 가점",
    category: "부동산·청약",
    description: "무주택기간, 부양가족수, 본인과 배우자 청약통장 가입기간을 기준으로 청약 가점을 계산합니다.",
    keywords: ["청약 가점 계산기", "청약 점수 계산", "무주택기간 계산"],
    formula: "청약가점 총점은 무주택기간 점수, 부양가족수 점수, 청약통장 가입기간 점수를 합산해 계산합니다. 배우자 통장 가점은 최대 3점이며 통장 합계는 17점이 상한입니다.",
